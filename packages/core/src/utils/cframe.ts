...
/**
 * Calculates the distance between two CFrames, taking the minimum of
 * positional distance and angular distance.
 *
 ...
 * ```
 * @remarks
 * Angular distance is calculated by converting both CFrames to Euler angles
 * and computing the vector distance between them. Positional distance uses
 * the vector distance of the CFrame positions.
 */
