 ...
 *
 * @remarks
 * For each property in `T`, if the property has a `$className` field
 * matching `U` or is itself a string literal matching `U`, it is included
 ...
 *
 * @remarks
 * The schemas are deeply frozen to prevent accidental mutation.
 * Includes `humanoid`, `r6Character`, and `r15Character` schemas.
 */
