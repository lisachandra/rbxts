 ...
 *
 * @remarks
 *   Uses shallow equality via `@rbxts/sift`'s `equals` to compare dependency arrays. Always returns
 ...
 * 	```;
 *
 * @param dependencies - An array of values to compare against the previous invocation.
